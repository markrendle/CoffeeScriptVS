...
using MarkRendle.CoffeeScriptLanguageService;

namespace CoffeeScriptLanguageService_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new CoffeeScriptLanguageServicePackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(MarkRendle.CoffeeScriptLanguageService.GuidList.guidCoffeeScriptLanguageServiceCmdSet, (int)MarkRendle.CoffeeScriptLanguageService.PkgCmdIDList.cmdInsertSnippet);
